...
export class FavoritesController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Artist has been successfully added to favorites',
  })
  ...
  @ApiResponse({
    status: 204,
    description: 'Artist has been successfully deleted from favorites',
  })
  @ApiResponse({ status: 400, description: 'Bad request' })
  @ApiResponse({
    status: 404,
  ...
  @ApiResponse({
    status: 201,
    description: 'Album has been successfully added to favorites',
  })
  @ApiResponse({ status: 400, description: 'Bad request' })
  ...
  @ApiResponse({
    status: 204,
    description: 'Album has been successfully deleted from favorites',
  })
  @ApiResponse({ status: 400, description: 'Bad request' })
  ...
  @ApiResponse({
    status: 201,
    description: 'Track has been successfully added to favorites',
  })
  @ApiResponse({ status: 400, description: 'Bad request' })
  ...
  @ApiResponse({
    status: 204,
    description: 'Track has been successfully deleted from favorites',
  })
  @ApiResponse({ status: 400, description: 'Bad request' })
